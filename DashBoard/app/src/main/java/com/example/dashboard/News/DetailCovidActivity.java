...
public class DetailCovidActivity extends AppCompatActivity {
    ...
    private void ApiCall(String countryName) {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, URL,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DetailCovidActivity.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        finish();
        Intent intent = new Intent(DetailCovidActivity.this , AllCountriesActivity.class);
